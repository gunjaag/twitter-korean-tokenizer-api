        ...
        <div class="container-fluid" style="margin-top: 20px">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <textarea class="form-control" rows="10" id="response1" placeholder="Tokenized Korean Text"></textarea>
                    <hr>
                    <textarea class="form-control" rows="10" id="response2" placeholder="Tokenized Korean Text with Speech Parts"></textarea>
                </div>
            </div>
            <hr>
            <footer>
                <p>No CopyRight Gunja Agrawal 2014 :)</p>
            </footer>
        </div>
        <!-- /container -->
